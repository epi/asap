...
java/android/AndroidASAP-resources.apk: $(addprefix $(srcdir)java/android/,AndroidManifest.xml \
	...
	res/layout/fileinfo_list_item.xml res/layout/shuffle_all_list_item.xml res/layout/player.xml res/menu/player.xml res/values/strings.xml res/values/themes.xml res/xml/searchable.xml) \
